...
class Test(object):
    ...
    def test_service_movie(self):
        ...
        self.__serv=Construct_Movie(validMovie,repoMovie,undoActions,redoActions)
    ...
    def test_service_client(self):
        ...
        undoActions=StackUndo()
        redoActions=StackUndo()
        self.__service=Construct_Client(validatorClient,repoClient,undoActions,redoActions)
