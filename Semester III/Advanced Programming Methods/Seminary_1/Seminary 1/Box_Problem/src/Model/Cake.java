package Model;
/*
Class which defines a cake object
 */
public class Cake implements Box{
    int id_number;
    String type;
    double density,volume;
    public Cake(int id_number, String type, double density,double volume)
    {
    ...
    /*
    Function which returns the id of the object
    Input: -
     ...
     */
    @Override
    public void Set_Density(double new_density) { this.density=new_density;}
    ...
    /*
    Function which returns a string in order to print a cake object( it is to string method )
    Input: -
    Output: string- which will be used for printing a cake object
     */
    @Override
