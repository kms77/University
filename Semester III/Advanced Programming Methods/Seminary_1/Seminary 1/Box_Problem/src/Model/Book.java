...
/*
Class which defines a book object
 */
public class Book implements Box {
    int id_number;
    String type;
    double density, volume;
    public Book(int id_number, String type, int density, int volume)
    {
    ...
    /*
    Function which returns a string in order to print a book object( it is to string method )
    Input: -
    Output: string- which will be used for printing a book object
     */
    @Override
